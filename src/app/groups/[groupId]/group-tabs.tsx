...
import { Info, Receipt, Scale, Settings } from 'lucide-react'
...
export function GroupTabs({ groupId }: Props) {
  ...
  return (
    <Tabs
      value={value}
      className="flex-1 min-w-0 overflow-x-auto rounded-xl bg-secondary/45 p-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      onValueChange={(value) => {
