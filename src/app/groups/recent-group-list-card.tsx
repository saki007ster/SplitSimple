...
export function RecentGroupListCard({
  ...
  return (
    <li key={group.id}>
      <Button
        variant="secondary"
        className="h-fit w-full rounded-2xl border bg-card px-1 py-3 shadow-sm hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-md"
        asChild
      >
        <div
          className="text-base"
          ...
          <div className="w-full flex flex-col gap-1">
            <div className="flex justify-between gap-2 text-base">
              <Link
                ...
                className="flex-1 overflow-hidden text-ellipsis px-2 text-left font-bold tracking-tight"
              >
                {group.name}
              </Link>
            ...
            <div className="px-2 text-xs font-normal text-muted-foreground">
              {groupDetail ? (
