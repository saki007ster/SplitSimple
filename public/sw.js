...
const PRECACHE = `splitsimple-precache-${CACHE_VERSION}`
const RUNTIME = `splitsimple-runtime-${CACHE_VERSION}`
const IMAGE_CACHE = `splitsimple-images-${CACHE_VERSION}`

const OFFLINE_URL = '/offline.html'

// Minimal app shell precached on install so the app can boot offline.
const PRECACHE_URLS = [OFFLINE_URL, '/manifest.webmanifest', '/logo.svg']
